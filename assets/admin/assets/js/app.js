!function (t) {
    ...
    function s(e) {
        1 == t("#light-mode-switch").prop("checked") && "light-mode-switch" === e ? (t("#dark-mode-switch").prop("checked", !1), t("#rtl-mode-switch").prop("checked", !1), t("#bootstrap-style").attr("href", "dashboard_assets/assets/css/bootstrap.min.css"), t("#app-style").attr("http://sabimen.test/dashboard_assets/assets/css/app.min.css"), sessionStorage.setItem("is_visited", "light-mode-switch")) : 1 == t("#dark-mode-switch").prop("checked") && "dark-mode-switch" === e ? (t("#light-mode-switch").prop("checked", !1), t("#rtl-mode-switch").prop("checked", !1), t("#bootstrap-style").attr("http://sabimen.test/dashboard_assets/assets/css/bootstrap-dark.min.css"), t("#app-style").attr("http://sabimen.test/dashboard_assets/assets/css/app-dark.min.css"), sessionStorage.setItem("is_visited", "dark-mode-switch")) : 1 == t("#rtl-mode-switch").prop("checked") && "rtl-mode-switch" === e && (t("#light-mode-switch").prop("checked", !1), t("#dark-mode-switch").prop("checked", !1), t("#bootstrap-style").attr("http://sabimen.test/dashboard_assets/assets/css/bootstrap.min.css"), t("#app-style").attr("http://sabimen.test/dashboard_assets/assets/css/app-rtl.min.css"), sessionStorage.setItem("is_visited", "rtl-mode-switch"))
    }
